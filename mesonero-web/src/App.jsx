...
function App() {
  ...
  return (
    <main className="min-h-screen px-4 py-5 sm:px-6 lg:px-8">
      <div className="mx-auto mb-3 flex w-full max-w-[1200px] items-center justify-between rounded-xl border border-cyan-500/30 bg-slate-900/70 px-3 py-2 text-xs text-slate-200">
        <span>Sesion: {session?.usuario} ({session?.rol})</span>
        <button type="button" className="rounded-md border border-slate-600 px-2 py-1" onClick={handleLogout}>Cerrar sesion</button>
      </div>
      <OrderWizard
