...
function OrderWizard({ currentOrder, setCurrentOrder, initialOrder }) {
  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-2.5rem)] w-full max-w-7xl flex-col gap-5 lg:flex-row">
      <section className="glass-panel relative flex-1 overflow-hidden rounded-[28px] p-4 shadow-glow sm:p-6 lg:p-8">
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(255,107,53,0.14),transparent_26%),radial-gradient(circle_at_bottom_right,rgba(255,107,53,0.1),transparent_24%)]" />
              ...
              <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-2">
                {menu[selectedCategory].map((item) => (
                  <button
                    ...
                    className="group min-h-[148px] rounded-[28px] border border-carbonLine bg-carbon p-5 text-left transition hover:-translate-y-0.5 hover:border-sunset/70 hover:bg-carbonCard"
                  >
                    ...
                    <div className="mt-5 flex items-end justify-between gap-3">
                      <div>
                        ...
                        <p className="mt-2 text-sm text-slate-300">
                          Pasa al paso 3 para elegir una nota rapida.
                        </p>
                      </div>
